# --- Pacman Game (DFS & BFS with Visualized Path & Visited Nodes) ---
import pygame
import time
...
SEARCH_ALGO = 'dfs'  # Change to 'bfs' or 'dfs'
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Pacman - DFS & BFS with Visualization")
        ...
        # Save original path for drawing
